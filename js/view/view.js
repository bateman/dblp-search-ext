  ...
  buildTable(publications) {
    ...
    publications.forEach((result) => {
      ...
      htmlTable +=
        ...
        "</a></td>";
      htmlTable +=
        '<td class="center"><img class="access" src="../images/' +
        result.access +
        '-access.png" title="This publication is ' +
        result.access +
        ' access"></td>';
      htmlTable +=
        '<td class="center"><button class="copyBibtexButton" title="Copy BibTex" data-url="' +
        result.bibtexLink +
        '"><img src="../images/copy.png"></button></td>';
      htmlTable += "</tr>";
    });
    htmlTable += "</tbody>";
    htmlTable += "</table>";
